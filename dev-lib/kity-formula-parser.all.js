/*!
 * ====================================================
 * Kity Formula Parser - v1.0.0 - 2018-08-20
...
_p[16] = {
    value: function(require) {
        var ScriptExtractor = _p.r(17);
        return function(info, processedStack, unprocessedStack) {
            var count = unprocessedStack.shift(), type = unprocessedStack.shift(), position = unprocessedStack.shift(), params = ScriptExtractor.exec(unprocessedStack);
...
//src/impl/latex/handler/placeholder.js
/*
*
*/
_p[22] = {
...
//src/impl/latex/handler/vertical.js
/*!
 * 纵向二元结合函数
 */
_p[26] = {
    value: function() {
        return function(info, processStack, unprocessStack) {
            return {
                name: "vertical",
                operand: [ unprocessStack.shift() || "\\empty", unprocessStack.shift() || "\\empty" ]
            };
        };
    }
};
...
_p[27] = {
    value: function(require) {
        var Parser = _p.r(48).Parser, LatexUtils = _p.r(1), PRE_HANDLER = _p.r(8), serialization = _p.r(47), OP_DEFINE = _p.r(7), REVERSE_DEFINE = _p.r(9), SPECIAL_LIST = _p.r(10), Utils = _p.r(4);
        // data
...
//src/impl/latex/reverse/placeholder.js
/*
*
*/
_p[40] = {
...
_p[44] = {
     ...
     */
        return function(operands) {
            ...
            result.push(" " + operands[0]);
            if (this.callFn && this.callFn.setType) {
                if (this.callFn.setType[0] == "a" || this.callFn.setType[0] == "v") {
...
//src/impl/latex/reverse/vertical.js
/*!
 * 逆解析处理函数: vertical
 */
_p[46] = {
